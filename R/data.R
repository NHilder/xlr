...
#'  \item{age_group}{A character vector for grouped age, gendereated from `age`}
...
#'  \item{Q2_1,2,3,4,5,6}{Mulitple response columns. Question asking what is your favourite colour to wear.}
#'  \item{Q3_1,2,3}{Mulitple response columns. Question asking what is your favourite jewellery to wear.}
